...
DOCS_DIR = "docs"
MAIN_PAGE_PATH = os.path.join(DOCS_DIR, "README.mediawiki")
PROJECTS_PAGE_PATH = os.path.join(DOCS_DIR, "Projects.mediawiki")
...
def generate_wiki_article(repo):
    ...
    prompt = f"""
Create a Wikipedia-style article in MediaWiki format for the following GitHub repository:
Repo Name: {name}
...
- Output ONLY the MediaWiki content.
"""
        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "Wikipedia articles in MediaWiki format."
                ),
            },
    ...
    if repo_links:
        ...
        if not any("Browse all project repositories" in line for line in main_lines):
            ...
            if nav_index != -1:
                ...
                main_lines.append(project_link_msg)
